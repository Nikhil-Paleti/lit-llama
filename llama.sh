...
mkdir checkpoints
mkdir checkpoints/llama
MODEL_SIZE="7B"  # edit this list with the model sizes you wish to download ,13B,30B,65B
TARGET_FOLDER="./checkpoints/llama"             # where all files should end up
